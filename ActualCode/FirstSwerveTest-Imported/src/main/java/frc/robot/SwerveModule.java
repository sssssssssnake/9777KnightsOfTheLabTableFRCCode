...
public class SwerveModule {
  ...
  private final SimpleMotorFeedforward m_turnFeedforward = new SimpleMotorFeedforward(0, 0); //ks: 1, kv: 0.5
   ...
   * @param turnEncoder CANbus Channel for the CTRE CANcoder
   */
  public SwerveModule(
    ...
    //Initialzing the turning Encoder for each Swerve Module
    // m_driveEncoder.setDistancePerPulse(2 * Math.PI * kWheelRadius / kEncoderResolution);
    drivingEncoder.setVelocityConversionFactor(2 * Math.PI * kWheelRadius / kEncoderResolution);
    drivingEncoder.setPositionConversionFactor(2 * Math.PI * kWheelRadius / kEncoderResolution);
  ...
  public SwerveModuleState getState() {
    return new SwerveModuleState(
        drivingEncoder.getVelocity(), new Rotation2d(
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    final double driveOutput =
        m_drivePIDController.calculate(drivingEncoder.getVelocity(), state.speedMetersPerSecond);
