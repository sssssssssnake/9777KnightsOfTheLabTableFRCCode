...
class Robot : public frc::TimedRobot {
 public:
  void TeleopPeriodic() override { m_motor.Set(myController.GetRightY()); }
 ...
 private:
  ...
  frc::XboxController myController{0};
  // frc::PWMSparkMax m_motor{9};
  rev::CANSparkMax m_motor{2, rev::CANSparkMaxLowLevel::MotorType::kBrushless};
